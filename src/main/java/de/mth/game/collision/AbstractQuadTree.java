...
public abstract class AbstractQuadTree {
	...
	private AbstractQuadTree[] nodes;

	/*
	 * Constructor
	 */
	public AbstractQuadTree(int pLevel, Rectangle pBounds) {
		level = pLevel;
		objects = new ArrayList<Rectangle>();
		bounds = pBounds;
		nodes = new AbstractQuadTree[4];
	}
	...
	private void split() {
		...
		// nodes[0] = new AbstractQuadTree(level + 1, new Rectangle(x +
		// subWidth,
		// y, subWidth, subHeight));
		// nodes[1] = new AbstractQuadTree(level + 1, new Rectangle(x, y,
		// subWidth, subHeight));
		// nodes[2] = new AbstractQuadTree(level + 1, new Rectangle(x, y
		// + subHeight, subWidth, subHeight));
		// nodes[3] = new AbstractQuadTree(level + 1, new Rectangle(x +
		// subWidth,
